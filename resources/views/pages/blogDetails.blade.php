...
@section('content')
    <div class="blog-details-container">
        <div class="blog-meta">
            <span class="blog-creator">Created by: {{ $blog->creator ? $blog->creator->user_fname . ' ' . $blog->creator->user_lname : 'Unknown' }}</span>,
            <span class="blog-date">Date Added: {{ \Carbon\Carbon::parse($blog->created_at)->format('F j, Y') }}</span>
        </div>
